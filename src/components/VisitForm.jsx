      ...
      <div className={styles.modal}>
        ...
        <form className={styles.modalBody} onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea className="form-control" rows={4} value={form.prescription} onChange={set('prescription')} placeholder="Tab. Paracetamol 500mg — 1 tab TDS × 5 days…" style={{ fontFamily: 'monospace', fontSize: '13px' }} />
          </div>
          ...
          <div className="form-group">
            ...
            <div className={styles.fileRow}>
              ...
              {form.prescription_path && (
                <button type="button" className="btn btn-secondary" onClick={() => setForm((f) => ({ ...f, prescription_path: '' }))}>✕</button>
              )}
            </div>
          </div>
          ...
          <div className={styles.finalAmount}>
            ...
            <strong>₹{finalAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</strong>
          </div>
